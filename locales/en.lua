Locales['en'] = {
  ...
  ['nosebh'] = 'Nose Bridge',
  ['nosepl'] = 'Nose Peak',
  ['noset'] = 'Nose Thickness',
  ['eyebh'] = 'Eyebrow Height',
  ['eyebf'] = 'Eyebrow Forward',
  ['cbh'] = 'Cheekbone Height',
  ['cbw'] = 'Cheekbone Width',
  ['chw'] = 'Cheek Width',
  ['eyeop'] = 'Eye Opening',
  ['lipst'] = 'Lips Thickness',
  ['jbw'] = 'Jawbone Width',
  ['jbbl'] = 'Jawbone Length',
  ['chbbl'] = 'Chinbone Lowering',
  ['chbw'] = 'Chinbone Length',
  ['chbble'] = 'Chinbone Width',
  ['chho'] = 'Chinbone Hole',
  ['neckt'] = 'Neck Width',
  ['wrinkles'] = 'wrinkles',
